...
function dontSave(event) {
	...
	//alert("save="+save+", save.disabled="+save.disabled+", cluster.event.keyCode="+cluster.event.keyCode+", typeof(cluster.event.keyCode)="+typeof(cluster.event.keyCode)+", cluster.event.which="+cluster.event.which+", typeof(cluster.event.which)="+typeof(cluster.event.which));
