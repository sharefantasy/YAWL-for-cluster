...
public class YEngineClusterExtent extends YEngine {
	 ...
	 */
	protected YEngineClusterExtent() {
	...
	public static YEngine getInstance(boolean persisting, boolean gatherHbnStats) throws YPersistenceException {
		if (_thisInstance == null) {
			_thisInstance = new YEngineClusterExtent();
			((YEngineClusterExtent) _thisInstance).persistenceInit(persisting, gatherHbnStats);
		}
	...
	private void persistenceInit(boolean persisting, boolean gatherHbnStats) throws YPersistenceException {
		...
		if (_persisting) {
			...
			((YEngineClusterExtent) _thisInstance).restore();
		} else {
