...
public class PersistenceManager extends HibernateEngine {
	...
	private static Class[] persistclasses = {Engine.class, EngineRole.class, Host.class, Tenant.class,
			TestPlanEntity.class, WorkflowPlan.class, HostCapability.class, EngineRoleSpeedRcd.class,
			TenantSpeedRcd.class, HostSpeedRcd.class};
