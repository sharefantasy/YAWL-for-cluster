...
public class YSessionTimer {
	...
	// inactivity - iff the timer interval set is +ve (a -ve interval means
	// never timeout)
	...
	// expires (removes) the active session. Called when a session timer
	// expires.
	private class TimeOut extends TimerTask {

		private final String _handle;

		public TimeOut(String handle) {
			_handle = handle;
		}

		public void run() {
			_cache.expire(_handle);
		}
	}
