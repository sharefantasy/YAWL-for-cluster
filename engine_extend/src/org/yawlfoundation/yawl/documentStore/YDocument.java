...
/**
 * Holds a binary file (of any type) to be passed as work item data. Note that
 * the file itself is located in the 'Document Store' service, only its name and
 * id are passed to and from the engine
 *
...
public class YDocument {
	 ...
	 * 
	 * @param caseID
	 *            the id of the case the document is a member of
	 * @param docID
	 *            the id of the internal binary file. Set it to a negative value
	 *            if the document has not yet been stored (and so does not yet
	 *            have an id)
	 * @param docAsBytes
	 *            a byte array representing the contents of the binary file
	 */
	 ...
	 *            have an id)
	 * @param docStream
	 *            a stream from which the contents of the binary file may be
	 *            read
	 * @throws IOException
	 *             if there's a problem reading from the stream
	 */
	 ...
	 * 
	 * @param id
	 *            the case id to set for this document
	 */
	 ...
	 * 
	 * @param doc
	 *            a byte array representing the contents of a binary file
	 */
	 ...
	 * 
	 * @param file
	 *            a File object containing a reference to a disk file to be read
	 *            into this document
	 * @throws IOException
	 ...
	 * 
	 * @param fileName
	 *            a fully qualified path and file name of a disk file to be read
	 *            into this document
	 * @throws IOException
	 *             if there's a problem loading the file
	 */
	 ...
	 * 
	 * @param fileName
	 *            a fully qualified path and file name of a disk file to write
	 * @throws IOException
	 ...
	 * 
	 * @param file
	 *            a File object containing a reference to a disk file to be
	 *            written to
	 * @throws IOException
	 *             if there's a problem writing the file
	 */
