...
public class YAWLServiceReference extends YClient implements YVerifiable {
	...
	public YAWLServiceReference(String serviceID, YAWLServiceGateway webGateway, String serviceName) {
	...
	public YAWLServiceReference(String serviceID, YAWLServiceGateway webGateway, String serviceName,
			String servicePassword, String doco) {
	...
	public boolean equals(Object other) {
		return (other instanceof YAWLServiceReference) && ((getServiceID() != null)
	...
	/**
	 * Returns the scheme (i.e. the protocol) component of the URI (assuming
	 * standard URI format). If no protocol defined, null is returned.
	 * <P>
	 *
