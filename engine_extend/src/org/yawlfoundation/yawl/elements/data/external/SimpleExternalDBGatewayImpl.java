...
public class SimpleExternalDBGatewayImpl extends AbstractExternalDBGateway {
	...
	private boolean configure() {
		if (!configured) {
			configureSession("org.hibernate.dialect.PostgreSQLDialect", "org.postgresql.Driver",
					"jdbc:postgresql:testDB", "postgres", "yawl", null);
			configured = true;
		}
		return configured;
	}
	...
	public Element populateCaseData(YSpecificationID specID, String caseID, List<YParameter> inputParams,
			List<YVariable> localVars, Element caseDataTemplate) {
		return null;
	}

	public void updateFromCaseData(YSpecificationID specID, String caseID, List<YParameter> outputParams,
