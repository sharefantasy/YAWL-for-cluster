...
/**
 * This class has control over data structures that allow for storing an
 * identifer and managing a set of children.
 *
...
public class YIdentifier {
	...
	private YIdentifier createChildWithID(YPersistenceManager pmgr, String id) throws YPersistenceException {
	...
	public synchronized void addLocation(YPersistenceManager pmgr, YNetElement condition) throws YPersistenceException {
		if (condition == null) {
	...
	public synchronized void clearLocations(YPersistenceManager pmgr) throws YPersistenceException {
		_locations.clear();
		locationNames.clear();
		updateThis(pmgr);
	}
	...
	public synchronized void removeLocation(YPersistenceManager pmgr, YNetElement condition)
			throws YPersistenceException {
		if (condition == null) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof YIdentifier) {
			...
			if ((toString() != null) && toString().equals(otherID.toString())) {
				return (getParent() == null) ? (otherID.getParent() == null) : getParent().equals(otherID.getParent());
			}
		}
		return false;
	}
