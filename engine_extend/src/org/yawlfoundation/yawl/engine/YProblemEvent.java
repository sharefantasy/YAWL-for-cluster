 ...
 *
 * 
 * @author Lachlan Aldred Date: 15/10/2004 Time: 11:50:00
 *
 */
public class YProblemEvent {
	...
	public YProblemEvent(Object source, String message, int eventType) {
		...
		if (source == null || (eventType != RuntimeError && eventType != RuntimeWarning)) {
			throw new IllegalArgumentException(
					"Check your arguments: " + "source cannot equal null and evenType must be a registered type.");
		}
	}
	...
	public void logProblem(YPersistenceManager pmgr) throws YPersistenceException {
		logger.error("Problem source: " + _source + " " + " Message: " + _message);
