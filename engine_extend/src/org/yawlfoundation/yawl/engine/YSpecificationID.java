 ...
 * <p/>
 * NOTE: For schema versions prior to 2.0, the spec's uri was used as its
 * identifier, but since a user-defined uri cannot guarantee uniqueness, the
 * identifier field was introduced for v2.0 (which will theoretically always be
 * unique). Specification versioning was also introduced in v2.0. Therefore, to
 * handle specifications of different schema versions: - all pre-2.0 schema
 * based specifications are given a default version of '0.1' - all pre-2.0
 * schema based specifications will have a null 'identifier' field and the 'uri'
 * field will be used to 'uniquely' identify the specification - all 2.0 and
 * later schema based specifications will use the 'identifier' field to uniquely
 * identify a specification-version family (all versions of a specification have
 * the same identifier).
 * <p/>
 * The getKey method is used to determine which of 'identifier' or 'uri' is used
 * as the unique identifier.
 *
 * @author Mike Fowler Date: 05-Sep-2006
...
public class YSpecificationID implements Comparable<YSpecificationID> {
	...
	public boolean isValid() {
		...
		// only 2.0 or later ids (i.e. with a non-null identifier) can have a
		// version
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof YSpecificationID) {
			...
			if ((other.getIdentifier() == null) && (getIdentifier() == null)) { // both
																				// pre-2.0
				equalYIDs = (other.getUri() != null) && (getUri() != null) && other.getUri().equals(getUri())
				...
				equalYIDs = (other.getIdentifier() != null) && (getIdentifier() != null)
						&& other.getIdentifier().equals(getIdentifier()) && other.getVersion().equals(getVersion());
			}
		}
		return equalYIDs;
	}
	...
	public String toXML() {
		...
		xml.append(StringUtil.wrap(version.getVersion(), "version")).append(StringUtil.wrap(uri, "uri"))
