...
/**
 * A container of objects that represent an engine generated event for
 * notification to observer gateways and services.
 *
...
public class YAnnouncement {
	...
	public boolean equals(Object o) {
		...
		if (o instanceof YAnnouncement) {
			...
			return _yawlService.equals(other._yawlService) && _item.equals(other._item) && (_event == other._event)
