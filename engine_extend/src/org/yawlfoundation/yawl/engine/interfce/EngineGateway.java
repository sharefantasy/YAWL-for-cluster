 ...
 * /**
 * 
 * @author Lachlan Aldred Date: 15/10/2004 Time: 11:28:22
 * 
 */
public interface EngineGateway extends Remote {
	...
	String getWorkItemExpiryTime(String workItemID, String sessionHandle) throws RemoteException;
	...
	String getSpecificationDataSchema(YSpecificationID specID, String sessionHandle) throws RemoteException;

	String launchCase(YSpecificationID specID, String caseParams, URI completionObserverURI, String caseID,
			String logDataStr, String sessionHandle) throws RemoteException;

	String launchCase(YSpecificationID specID, String caseParams, URI completionObserverURI, String logDataStr,
			String sessionHandle) throws RemoteException;

	String launchCase(YSpecificationID specID, String caseParams, URI completionObserverURI, String logDataStr,
			long mSec, String sessionHandle) throws RemoteException;

	String launchCase(YSpecificationID specID, String caseParams, URI completionObserverURI, String logDataStr,
			Date expiry, String sessionHandle) throws RemoteException;

	String launchCase(YSpecificationID specID, String caseParams, URI completionObserverURI, String logDataStr,
			Duration duration, String sessionHandle) throws RemoteException;
	...
	String getWorkItemInstanceSummary(String caseID, String sessionHandle) throws RemoteException;

	String getParameterInstanceSummary(String caseID, String itemID, String sessionHandle) throws RemoteException;
