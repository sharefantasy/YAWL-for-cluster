...
/**
 * A 'stringified' record of a workitem for passing across various HTTP
 * interfaces
 *
 * @author Lachlan Aldred Date: 2/02/2004 Time: 18:30:18
 *
 *         Extended & refactored for version 2.0 by Michael Adams Last Date:
 *         27/05/2008
 * 
 */
...
public class WorkItemRecord implements Cloneable {
	...
	public WorkItemRecord(String caseID, String taskID, String specURI, String enablementTime, String status) {
		_taskID = taskID;
		_caseID = caseID;
		_specURI = specURI;
	...
	public String getEnablementTimeMs() {
		return _enablementTimeMs;
	}

	public String getFiringTimeMs() {
		return _firingTimeMs;
	}
	...
	public String getLogPredicateStarted() {
		return _logPredicateStarted;
	}

	public String getLogPredicateCompletion() {
		return _logPredicateCompletion;
	}
	...
	public boolean equals(Object o) {
		...
		if (o instanceof WorkItemRecord) {
			...
			return getID().equals(other.getID()) && _status.equals(other.getStatus()) && _uniqueID != null
					? _uniqueID.equals(other._uniqueID)
	...
	public String toXML() {
		...
		xml.append(_extendedAttributes != null ? _extendedAttributes : "").append(">")
				.append(StringUtil.wrap(getID(), "id")).append(StringUtil.wrap(_specVersion, "specversion"))
				.append(StringUtil.wrap(_specURI, "specuri")).append(StringUtil.wrap(_caseID, "caseid"))
				.append(StringUtil.wrap(_taskID, "taskid")).append(StringUtil.wrap(_uniqueID, "uniqueid"))
		...
		xml.append(StringUtil.wrap(_allowsDynamicCreation, "allowsdynamiccreation"))
				...
				.append(StringUtil.wrap(_firingTime, "firingTime")).append(StringUtil.wrap(_startTime, "startTime"))
				...
				.append(StringUtil.wrap(_timerExpiry, "timerexpiry")).append(StringUtil.wrap(_status, "status"))
				.append(StringUtil.wrap(_resourceStatus, "resourceStatus"))
				.append(StringUtil.wrap(_startedBy, "startedBy")).append(StringUtil.wrap(_completedBy, "completedBy"))
				.append(StringUtil.wrap(_tag, "tag")).append(StringUtil.wrap(_customFormURL, "customform"))
		...
		xml.append("<data>").append(_dataList != null ? JDOMUtil.elementToStringDump(_dataList) : "").append("</data>")
				.append("<updateddata>")
				.append(_dataListUpdated != null ? JDOMUtil.elementToStringDump(_dataListUpdated) : "")
				.append("</updateddata>").append("</workItemRecord>");
	...
	private String attributeTableToAttributeString() {
		...
		for (String key : _attributeTable.keySet()) {
			xml.append(" ").append(key).append("=\"").append(_attributeTable.get(key)).append("\"");
		}
		return xml.toString();
	}
	...
	private void set_dataListUpdated(String data) {
		_dataListUpdatedString = data;
	}

	private String get_dataListUpdated() {
		return _dataListUpdatedString;
	}
