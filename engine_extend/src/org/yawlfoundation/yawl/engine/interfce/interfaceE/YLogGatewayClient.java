...
/**
 * An API to be used by clients that want to retrieve data from the YAWL process
 * logs.
 *
 * @author Michael Adams 29/10/2007
 *
...
public class YLogGatewayClient extends Interface_Client {
	...
	/**
	 * the uri of the YAWL Engine's __logGateway__ a default would be
	 ...
	 * 
	 * @param uri
	 *            the uri of the YAWL engine's log gateway
	 */
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getNetInstancesOfSpecification(String identifier, String version, String uri, String handle)
			throws IOException {
	 ...
	 * 
	 * @param specKey
	 *            the primary key identifier of the specification in its log
	 *            table
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	...
	/**
	 * Gets a complete listing of all the cases launched from the specification
	 * data passed, including all net & task instances, events and data items
	 * 
	 * @param identifier
	 *            the unique identifier of the specification
	 * @param version
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getCompleteCaseLogsForSpecification(String identifier, String version, String uri, String handle)
			throws IOException {
	...
	/**
	 * Gets a complete listing of all the cases launched from the specification
	 * key passed, including all net & task instances, events and data items
	 * 
	 * @param specKey
	 *            the primary key identifier of the specification in its log
	 *            table
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getCompleteCaseLogsForSpecification(long specKey, String handle) throws IOException {
		return performGet("getCompleteCaseLogsForSpecification", "key", specKey, handle);
	}

	/**
	 * Gets a set of summary statistics for executed instances of the
	 * specification data passed
	 * 
	 * @param identifier
	 *            the unique identifier of the specification
	 * @param version
	 ...
	 *            the specification's uri
	 * @param from
	 *            the start of the range of timestamps to include
	 * @param to
	 *            the end of the range of timestamps to include
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getSpecificationStatistics(long specKey, String handle) throws IOException {
		return performGet("getSpecificationStatistics", "key", specKey, handle);
	}

	/**
	 * Gets the set of case ids for executed instances of the specification data
	 * passed
	 * 
	 * @param specID
	 *            the unique identifier of the specification
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getSpecificationCaseIDs(YSpecificationID specID, String handle) throws IOException {
	...
	/**
	 * Gets a set of case ids for executed instances of the specification key
	 * passed
	 * 
	 * @param specKey
	 *            the primary key identifier of the specification in its log
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getSpecificationCaseIDs(long specKey, String handle) throws IOException {
	 ...
	 * 
	 * @param rootNetInstanceKey
	 *            the primary key identifier of the root net instance of the
	 *            case
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 ...
	 * 
	 * @param caseID
	 *            the case id of the case to get the events for
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 * 
	 * @param eventKey
	 *            the primary key identifier of the event
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 * 
	 * @param instanceKey
	 *            the primary key identifier of the net or task instance
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 * 
	 * @param dataTypeKey
	 *            the primary key identifier of the data type
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	...
	/**
	 * Gets a comprehensive listing of all of the data logged for the case
	 * passed, including all net & task instances, events and data items
	 * 
	 * @param caseID
	 *            the case id to get the log data for
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	...
	/**
	 * Gets a listing of all the task instances (ie work items) created for the
	 * case
	 * 
	 * @param caseID
	 *            the case id to get the log data for
	 ...
	 * 
	 * @param taskKey
	 *            the primary key identifier of the task definition
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	...
	/**
	 * Gets a listing of all the task instances (ie work items) created for the
	 * task within a specified case
	 * 
	 * @param rootCaseID
	 *            the root case id of the case to get the task instances for
	 * @param taskName
	 *            the primary key identifier of the task definition
	 * @param handle
	 *            an active sessionhandle
	 ...
	 *             if there's a problem connecting to the engine
	 */
	public String getTaskInstancesForTask(String rootCaseID, String taskName, String handle) throws IOException {
	 ...
	 * 
	 * @param caseID
	 *            the case id to get the event for
	 * @param eventType
	 *            the 'name' of the event (eg 'CaseStart')
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 * @param handle
	 *            an active sessionhandle
	 * @return an XML'd String list of Case Start events triggered by the
	 *         service
	 * @throws java.io.IOException
	 *             if there's a problem connecting to the engine
	 */
	 ...
	 * @param handle
	 *            an active sessionhandle
	 * @return an XML'd String list of Case Cancellation events triggered by the
	 *         service
	 * @throws java.io.IOException
	 *             if there's a problem connecting to the engine
	 */
	 ...
	 * 
	 * @param serviceKey
	 *            the primary key identifier of the service
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 *            the specification's uri
	 * @param withData
	 *            if true, all data change events will be included
	 * @param handle
	 *            an active sessionhandle
	 * @return the resultant String response (log data or error message)
	 * @throws java.io.IOException
	 ...
	 */
	public String getSpecificationXESLog(String identifier, String version, String uri, boolean withData, String handle)
			throws IOException {
	 ...
	 */
	public String getSpecificationXESLog(YSpecificationID specID, String handle) throws IOException {
		return getSpecificationXESLog(specID.getIdentifier(), specID.getVersionAsString(), specID.getUri(), false,
				handle);
	}
	 ...
	 * @see #getSpecificationXESLog(String, String, String, String)
	 */
	public String getSpecificationXESLog(YSpecificationID specID, boolean withData, String handle) throws IOException {
		return getSpecificationXESLog(specID.getIdentifier(), specID.getVersionAsString(), specID.getUri(), withData,
				handle);
	}
