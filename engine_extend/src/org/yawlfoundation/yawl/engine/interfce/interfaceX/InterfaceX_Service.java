...
/**
 * The interface InterfaceX_Service defines the exception event methods that are
 * passed from the engine to the exception service. It is designed to be
 * implemented by the exception service class.
 *
