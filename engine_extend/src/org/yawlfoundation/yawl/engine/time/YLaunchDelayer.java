 ...
 *
 * Author: Michael Adams Creation Date: 09/02/2012
 */
...
public class YLaunchDelayer implements YTimedObject {
	...
	private YLaunchDelayer(YSpecificationID specID, String caseParams, URI completionObserver, String caseID,
			YLogDataItemList logData, String serviceHandle, boolean persisting) {
		_specID = specID;
	...
	public YLaunchDelayer(YSpecificationID specID, String caseParams, URI completionObserver, String caseID,
			YLogDataItemList logData, String serviceHandle, long msec, boolean persisting) {
	...
	public YLaunchDelayer(YSpecificationID specID, String caseParams, URI completionObserver, String caseID,
			YLogDataItemList logData, String serviceHandle, Date expiryTime, boolean persisting) {
		this(specID, caseParams, completionObserver, caseID, logData, serviceHandle, persisting);
	...
	public YLaunchDelayer(YSpecificationID specID, String caseParams, URI completionObserver, String caseID,
			YLogDataItemList logData, String serviceHandle, Duration duration, boolean persisting) {
		this(specID, caseParams, completionObserver, caseID, logData, serviceHandle, persisting);
	...
	public YLaunchDelayer(YSpecificationID specID, String caseParams, URI completionObserver, String caseID,
			YLogDataItemList logData, String serviceHandle, long units, YTimer.TimeUnit interval, boolean persisting) {
		this(specID, caseParams, completionObserver, caseID, logData, serviceHandle, persisting);
		...
		if (_persisting) {
			...
			if (pmgr != null) {
				try {
					...
					if (insert)
						pmgr.storeObjectFromExternal(this);
					else
	...
	public boolean equals(Object other) {
		return (other instanceof YLaunchDelayer) && ((getOwnerID() != null)
	...
	public void handleTimerExpiry() {
		try {
			YEngine.getInstance().launchCase(_specID, _caseParams, _completionObserver, _caseID, _logData, _serviceURI,
					true);
		} catch (YAWLException ye) {
			Logger.getLogger(YLaunchDelayer.class).error("Unable to launch delayed instance of " + _specID.toString(),
					ye);
		}
