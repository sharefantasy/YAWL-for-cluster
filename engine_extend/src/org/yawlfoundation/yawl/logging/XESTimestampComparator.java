 ...
 * <p/>
 * Author: Michael Adams Creation Date: 12/08/2011
 */
public class XESTimestampComparator implements Comparator<XNode> {
	...
	public int compare(XNode node1, XNode node2) {
		...
		if (!node1.getName().equals("event"))
			return -1;
		if (!node2.getName().equals("event"))
			return 1;
		...
		// if identical timestamps, return the longer id (i.e. the child item
		// event)
