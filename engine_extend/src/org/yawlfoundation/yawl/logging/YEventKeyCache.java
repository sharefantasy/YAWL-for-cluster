...
public class YEventKeyCache {
	...
	// [netID, [taskName, taskID]] - removed when spec unloaded (via netID
	// relation)
	...
	// [caseID, [taskID, taskInstanceID]] - removed when case completes or
	// cancelled
	...
	protected void removeCase(YIdentifier caseID) {
		for (YIdentifier descendant : caseID.getDescendants()) { // includes
																	// parent
