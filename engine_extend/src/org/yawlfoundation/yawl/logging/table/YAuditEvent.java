...
/**
 * Author: Michael Adams Creation Date: 22/10/2009
 */
public class YAuditEvent {

	public static enum Action {
		logon, logoff, invalid, unknown, shutdown, expired
	}
	...
	public boolean equals(Object other) {
		return (other instanceof YAuditEvent) && (this.get_id() == ((YAuditEvent) other).get_id());
	}
