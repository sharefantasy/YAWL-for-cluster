...
/**
 * One row of the logDataItem table, representing a data item associated with an
 * event. Note that an event may have a number of data items associated with it.
 *
