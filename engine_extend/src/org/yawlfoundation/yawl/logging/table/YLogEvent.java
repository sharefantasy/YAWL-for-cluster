...
/**
 * One row of the logEvent table, representing a single net or task instance
 * runtime event
 *
...
public class YLogEvent {
	...
	public YLogEvent(long instanceID, String descriptor, long timestamp, long serviceID, long rootNetInstanceID) {
	...
	public boolean equals(Object other) {
		return (other instanceof YLogEvent) && (this.getEventID() == ((YLogEvent) other).getEventID());
	}
