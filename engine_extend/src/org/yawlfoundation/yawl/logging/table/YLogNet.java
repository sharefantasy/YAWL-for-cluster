...
/**
 * One row of the logNet table, representing a unique net 'template' of a
 * specification
 *
 * Author: Michael Adams Creation Date: 9/04/2009
 */
public class YLogNet {
	...
	public boolean equals(Object other) {
		return (other instanceof YLogNet) && (this.getNetID() == ((YLogNet) other).getNetID());
	}
