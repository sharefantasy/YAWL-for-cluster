...
/**
 * One row of the logNetInstance table, representing a runtime instance of a
 * net. Note that the engineInstanceID of a root net = the case id of the
 * running case instance
 *
...
public class YLogNetInstance {
	...
	private long parentTaskInstanceID; // FK to YLogTaskInstance (composite
										// tasks only)
