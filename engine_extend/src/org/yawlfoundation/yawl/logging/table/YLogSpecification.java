 ...
 *
 * Note that even though specID + version is unique across all rows, field 'key'
 * was used because it greatly simplifies hibernate accesses to have a PK is not
 * composite
 *
 * Author: Michael Adams Creation Date: 6/04/2009
 */
public class YLogSpecification {
	...
	public YLogSpecification(String identifier, YSpecVersion version, String uri, long rootNetID) {
	...
	public boolean equals(Object other) {
		return (other instanceof YLogSpecification) && (this.getRowKey() == ((YLogSpecification) other).getRowKey());
	}
