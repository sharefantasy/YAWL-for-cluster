...
/**
 * One row of the YLogTaskInstance table, representing a runtime instance of a
 * task
 *
...
public class YLogTaskInstance {
	...
	public YLogTaskInstance(String engineInstanceID, long taskID, long parentTaskInstanceID, long parentNetInstanceID) {
