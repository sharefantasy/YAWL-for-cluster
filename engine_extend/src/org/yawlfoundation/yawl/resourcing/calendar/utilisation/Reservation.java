...
public class Reservation extends StatusMessage {
	...
	public Reservation(String id, String statusToBe, String status, UtilisationResource resource, int workload) {
		setReservationID(id);
	...
	public void setStatusToBe(String status) {
		if (_statusToBe == null)
			_statusToBe = new StringWithMessage("StatusToBe");
	...
	public void setStatus(String status) {
		if (_status == null)
			_status = new StringWithMessage("Status");
	...
	public void setWorkload(int workload) {
		if (_workload == null)
			_workload = new StringWithMessage("Workload");
		_workload.setValue(workload);
	}

	public boolean hasErrors() {
		return hasError() || StringWithMessage.hasError(_statusToBe) || StringWithMessage.hasError(_status)
				|| StringWithMessage.hasError(_workload) || (hasResource() && _resource.hasErrors());
	}
	...
	public XNode toXNode() {
		...
		addAttributes(node);
		if (_statusToBe != null)
			node.addChild(_statusToBe.toXNode());
		if (_status != null)
			node.addChild(_status.toXNode());
		if (_workload != null)
			node.addChild(_workload.toXNode());
		if (_resource != null)
			node.addChild(_resource.toXNode());
