...
public class UtilisationResource {
	...
	public UtilisationResource(String id, String role, String capability, String category, String subcategory) {
		setID(id);
		setRole(role);
	...
	public void setRole(String s) {
		if (_role == null)
			_role = new StringWithMessage("Role");
		_role.setValue(s);
	}
	...
	public void setCapability(String s) {
		if (_capability == null)
			_capability = new StringWithMessage("Capability");
	...
	public void setCategory(String s) {
		if (_category == null)
			_category = new StringWithMessage("Category");
	...
	public void setSubcategory(String s) {
		if (_subcategory == null)
			_subcategory = new StringWithMessage("SubCategory");
		_subcategory.setValue(s);
	}

	public boolean hasErrors() {
		return StringWithMessage.hasError(_id) || StringWithMessage.hasError(_role)
				|| StringWithMessage.hasError(_capability) || StringWithMessage.hasError(_category)
	...
	public boolean equals(Object o) {
		return (o instanceof UtilisationResource) && toXML().equals(((UtilisationResource) o).toXML());
	}
	...
	public XNode toXNode() {
		...
		if (_id != null)
			node.addChild(_id.toXNode());
		if (_role != null)
			node.addChild(_role.toXNode());
		if (_capability != null)
			node.addChild(_capability.toXNode());
		if (_category != null)
			node.addChild(_category.toXNode());
		if (_subcategory != null)
			node.addChild(_subcategory.toXNode());
		return node;
	}
