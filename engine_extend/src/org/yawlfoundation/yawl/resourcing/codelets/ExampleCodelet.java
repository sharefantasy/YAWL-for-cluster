...
public class ExampleCodelet extends AbstractCodelet {
	...
	public ExampleCodelet() {
		...
		setDescription("This codelet is a simple example of codelet construction and<br> "
				+ "usage. It adds two integers. Required parameters:<br> " + "Inputs: a, b (both long types)<br>"
				+ "Output: c (also a long)");
	}

	/**
	 * The implementation of the abstract class that does the work of this
	 * codelet. Note that calls to most of the base class methods may throw a
