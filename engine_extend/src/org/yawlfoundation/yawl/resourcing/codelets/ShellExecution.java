...
/**
 * A codelet that executes an external program in the client environment. It
 * expects the following workitem input parameters: - command: the command line
 * (including any arguments) - env: an optional set of attrib-value pairs
 * representing temporary additions to the client environment (requires a
 * user-defined data type that will deliver data like this:
 * <env> <name1>value1</name> <name2>value2</name> ... <env> - dir: an optional
 * working directory
 *
 * @author Michael Adams Date: 18/06/2008
 */
public class ShellExecution extends AbstractCodelet {
	...
	public ShellExecution() {
		...
		setDescription("This codelet executes an external program. Required parameters:<br> "
				...
				+ "&nbsp;&nbsp;&nbsp; dir (type String, optional)<br>" + "Output: result (type String)");
	}
	 ...
	 *
	 * @param pb
	 *            an instantiated ProcessBuilder object
	 * @param inData
	 *            the input data
	 */
