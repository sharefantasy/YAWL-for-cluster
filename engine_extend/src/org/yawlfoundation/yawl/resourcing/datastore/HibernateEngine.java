...
public class HibernateEngine extends org.yawlfoundation.yawl.util.HibernateEngine {
	...
	private static Class[] persistedClasses = {Participant.class, Role.class, Capability.class, Position.class,
			OrgGroup.class, UserPrivileges.class, NonHumanResource.class, WorkQueue.class, ResourceMap.class,
			PersistedAutoTask.class, CalendarEntry.class, WorkItemRecord.class, ResourceEvent.class, AuditEvent.class,
			SpecLog.class, CalendarLogEntry.class, NonHumanCategory.class, NonHumanSubCategory.class};
