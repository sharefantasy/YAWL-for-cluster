 ...
 *
 * @author Michael Adams v0.1, 15/09/2007
 */
...
public class WorkItemCache extends ConcurrentHashMap<String, WorkItemRecord> {
	...
	class Cleanser {
		...
		Cleanser() {
			...
			_cleanseTask = _scheduler.scheduleAtFixedRate(new CleanseRunnable(), INTERVAL, INTERVAL, TimeUnit.MINUTES);
		}

		public void cancel() {
			if (_cleanseTask != null)
				_cleanseTask.cancel(true);
		}
