...
/**
 * This class provides a default DataSource object to the ResourceManager in the
 * event that there is no actual Datasource set and/or initialised.
 *
 * Author: Michael Adams Date: 10/04/2008
 */
