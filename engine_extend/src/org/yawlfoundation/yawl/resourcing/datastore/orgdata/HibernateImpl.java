...
public class HibernateImpl extends DataSource {
	 ...
	 * 
	 * @param obj
	 *            the object to generate a unique id for
	...
	public HashMap<String, NonHumanCategory> loadNonHumanCategories() {
		HashMap<String, NonHumanCategory> nhCategoryMap = new HashMap<String, NonHumanCategory>();
		List<NonHumanCategory> nhList = _db.getObjectsForClass(_nonHumanResourceCategory);
		for (NonHumanCategory r : nhList)
			nhCategoryMap.put(r.getID(), r);
		_db.commit();
