...
public final class Persister implements Serializable {
	...
	public Object load(Class claz, Serializable key) {
		return _db.load(claz, key);
	}

	public Object get(Class claz, Serializable key) {
		return _db.get(claz, key);
	}
	...
	public Object selectScalar(String className, String id) {
		...
		else if ((className.endsWith("QueueSet")) || (className.endsWith("WorkQueue")))
