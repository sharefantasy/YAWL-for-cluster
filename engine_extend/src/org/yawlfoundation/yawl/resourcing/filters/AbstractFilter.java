...
public abstract class AbstractFilter extends AbstractSelector {
	...
	/**
	 * @return an XML string describing this filter - used by the editor to
	...
	/**
	 * Abstract method, to be implemented by all child classes, which carries
	 * out whatever filtering the class has been created to do.
	 *
	 * @param resources
	 *            a distribution set of Participant objects
