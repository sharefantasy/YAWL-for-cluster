...
public abstract class AbstractInteraction {
	...
	public boolean setInitiator(int i) {
		if ((i == USER_INITIATED) || (i == SYSTEM_INITIATED)) {
			...
			return false; // invalid value passed
	...
	public boolean isSystemInitiated() {
		return _initiator == SYSTEM_INITIATED;
	}
	...
	public void parseInitiator(Element e, Namespace nsYawl) throws ResourceParseException {
		...
		if (initiator == null)
			throw new ResourceParseException("Missing attribute 'initiator' on resourcing element: " + e.getName());
