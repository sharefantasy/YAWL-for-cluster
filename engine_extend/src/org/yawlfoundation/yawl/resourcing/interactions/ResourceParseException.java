 ...
 *
 * An ResourceParseException is thrown when an attempt is made to parse the
 * resourcing specification for a task and the spec does not match the expected
 * content.
 *
 * @author Michael Adams v2.0, 05/02/2008
 */
