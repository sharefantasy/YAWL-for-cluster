...
public class adminQueues extends AbstractPageBean {
	...
	public void setLblAssignedTo(Label l) {
		lblAssignedTo = l;
	}
	...
	public void setLblResourceState(Label l) {
		lblResourceState = l;
	}
	...
	public void setTxtResourceState(TextField t) {
		txtResourceState = t;
	}
	...
	public void setCbbAssignedTo(DropDown dd) {
		cbbAssignedTo = dd;
	}
	...
	public Checkbox getCbxDirectToMe() {
		return cbxDirectToMe;
	}

	public void setCbxDirectToMe(Checkbox c) {
		cbxDirectToMe = c;
	}
	...
	public void setBtnSynch(Button btn) {
		btnSynch = btn;
	}
	...
	public void setBtnSecRes(Button btn) {
		btnSecRes = btn;
	}
	...
	public void prerender() {
		...
		if (!_sb.performAdminQueueAction()) {
			_msgPanel.error("Could not complete workitem action." + " Please see the log files for details.");
		}
		showMessagePanel();
	...
	private void updateTabHeaders(Tab selected) {
		...
		tabUnOffered.setText(String.format("Unoffered (%d)", _sb.getQueueSize(WorkQueue.UNOFFERED)));
		tabWorklisted.setText(String.format("Worklisted (%d)", _sb.getQueueSize(WorkQueue.WORKLISTED)));
	}
	...
	private void showMessagePanel() {
		body1.setFocus(_msgPanel.hasMessage() ? "form1:pfMsgPanel:btnOK001" : "form1:pfQueueUI:lbxItems");
