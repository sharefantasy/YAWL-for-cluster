...
public class calendarMgt extends AbstractPageBean {
	...
	public HtmlOutputText getColStartTimeRows() {
		return colStartTimeRows;
	}

	public void setColStartTimeRows(HtmlOutputText hot) {
		colStartTimeRows = hot;
	}

	private HtmlOutputText colStartTimeHeader = new HtmlOutputText();

	public HtmlOutputText getColStartTimeHeader() {
		return colStartTimeHeader;
	}

	public void setColStartTimeHeader(HtmlOutputText hot) {
		colStartTimeHeader = hot;
	}
	...
	public void setColEndTime(UIColumn uic) {
		colEndTime = uic;
	}
	...
	public HtmlOutputText getColEndTimeRows() {
		return colEndTimeRows;
	}

	public void setColEndTimeRows(HtmlOutputText hot) {
		colEndTimeRows = hot;
	}
	...
	public HtmlOutputText getColEndTimeHeader() {
		return colEndTimeHeader;
	}

	public void setColEndimeHeader(HtmlOutputText hot) {
		colEndTimeHeader = hot;
	}
	...
	public void setColStatus(UIColumn uic) {
		colStatus = uic;
	}
	...
	public HtmlOutputText getColStatusRows() {
		return colStatusRows;
	}

	public void setColStatusRows(HtmlOutputText hot) {
		colStatusRows = hot;
	}
	...
	public HtmlOutputText getColStatusHeader() {
		return colStatusHeader;
	}

	public void setColStatusHeader(HtmlOutputText hot) {
		colStatusHeader = hot;
	}
	...
	public void setColWorkload(UIColumn uic) {
		colWorkload = uic;
	}
	...
	public HtmlOutputText getColWorkloadRows() {
		return colWorkloadRows;
	}

	public void setColWorkloadRows(HtmlOutputText hot) {
		colWorkloadRows = hot;
	}
	...
	public HtmlOutputText getColWorkloadHeader() {
		return colWorkloadHeader;
	}

	public void setColWorkloadHeader(HtmlOutputText hot) {
		colWorkloadHeader = hot;
	}
	...
	public void setColComment(UIColumn uic) {
		colComment = uic;
	}
	...
	public HtmlOutputText getColCommentRows() {
		return colCommentRows;
	}

	public void setColCommentRows(HtmlOutputText hot) {
		colCommentRows = hot;
	}
	...
	public HtmlOutputText getCoCommentHeader() {
		return colCommentHeader;
	}

	public void setColCommentHeader(HtmlOutputText hot) {
		colCommentHeader = hot;
	}
	...
	public void setBtnYesterday(Button b) {
		btnYesterday = b;
	}
	...
	public void setBtnTomorrow(Button b) {
		btnTomorrow = b;
	}
	...
	public void setCalComponent(Calendar cal) {
		calComponent = cal;
	}
	...
	public void setLblFilter(Label lbl) {
		lblFilter = lbl;
	}
	...
	public void setCbbFilter(DropDown cbb) {
		cbbFilter = cbb;
	}
	...
	public void setLblResource(Label lbl) {
		lblResource = lbl;
	}
	...
	public void setCbbResource(DropDown cbb) {
		cbbResource = cbb;
	}
	...
	public void setCalPanel(PanelLayout pl) {
		calPanel = pl;
	}
	...
	public void setHeadingStart(StaticText st) {
		headingStart = st;
	}
	...
	public void setHeadingEnd(StaticText st) {
		headingEnd = st;
	}
	...
	public void setHeadingName(StaticText st) {
		headingName = st;
	}
	...
	public void setHeadingStatus(StaticText st) {
		headingStatus = st;
	}
	...
	public StaticText getHeadingWorkload() {
		return headingWorkload;
	}

	public void setHeadingWorkload(StaticText st) {
		headingWorkload = st;
	}
	...
	public StaticText getHeadingComments() {
		return headingComments;
	}

	public void setHeadingComments(StaticText st) {
		headingComments = st;
	}
	...
	public void setEditPanel(PanelLayout pl) {
		editPanel = pl;
	}
	...
	public void setUpperPanel(PanelLayout pl) {
		upperPanel = pl;
	}
	...
	public void setLblStart(Label lbl) {
		lblStart = lbl;
	}
	...
	public void setLblEnd(Label lbl) {
		lblEnd = lbl;
	}
	...
	public void setLblUntil(Label lbl) {
		lblUntil = lbl;
	}
	...
	public void setLblWorkload(Label lbl) {
		lblWorkload = lbl;
	}
	...
	public void setLblComments(Label lbl) {
		lblComments = lbl;
	}
	...
	public void setCalDuration(Calendar cal) {
		calDuration = cal;
	}
	...
	public void setTxtStartTime(TextField tf) {
		txtStartTime = tf;
	}
	...
	public void setTxtEndTime(TextField tf) {
		txtEndTime = tf;
	}
	...
	public void setTxtWorkload(TextField tf) {
		txtWorkload = tf;
	}
	...
	public void setTxtComments(TextField tf) {
		txtComments = tf;
	}
	...
	public void setCbxRepeat(Checkbox c) {
		cbxRepeat = c;
	}
	...
	public StaticText getSttResourceName() {
		return sttResourceName;
	}

	public void setSttResourceName(StaticText st) {
		sttResourceName = st;
	}
	...
	public void setLblResourceName(Label lbl) {
		lblResourceName = lbl;
	}
	...
	public String btnAdd_action() {
		if (validateFields()) {
			...
			if (startTime < endTime) {
				...
				_msgPanel.error("End time must come after start time.");
		}
		return null;
	}
		...
		try {
			if (cbxRepeat.isChecked()) {
				...
				while (startTime < endTime) {
					_sb.addCalendarEntry(startTime, getTime(endTimeStr, baseDate.getTime()), workload, comment);
	...
	private boolean updateCalendarEntry(long startTime, long endTime, int workload, String comment) {
		...
		if (entry != null) {
			...
			if (!_sb.clashesWithCalendar(entry, false)) {
				...
				_msgPanel.error("Cannot update entry. Times and/or workload" + " clashes with an existing entry.");
		} else
	...
	private void setResourceName() {
		...
		if ((name == null) || name.equals("Unfiltered"))
			name = "";
	...
	private void showMessagePanel() {
		if (_msgPanel.hasMessage())
			body1.setFocus("form1:pfMsgPanel:btnOK001");
	...
	private int getWorkloadValue() {
		...
		if (StringUtil.isNullOrEmpty(workload))
			return 100;
