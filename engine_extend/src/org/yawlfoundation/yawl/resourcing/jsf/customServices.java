 ...
 *
 * @author Michael Adams BPM Group, QUT Australia v0.1, 23/01/2008
 *
 *
...
public class customServices extends AbstractPageBean {
	...
	public void setLblConfirmPassword(Label l) {
		lblConfirmPassword = l;
	}
	...
	public void setTxtPassword(PasswordField pw) {
		txtPassword = pw;
	}
	...
	public void setDataList(List<YAWLServiceReference> d) {
		dataList = d;
	}
	...
	public String btnAdd_action() {
		...
		if (!(isNullOrEmpty(name) || isNullOrEmpty(password) || isNullOrEmpty(uri) || isNullOrEmpty(doco))) {
