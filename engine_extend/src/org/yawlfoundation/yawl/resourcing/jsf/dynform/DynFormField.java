...
public class DynFormField implements Cloneable {
	...
	public DynFormField(String name, List<DynFormField> subList) {
		...
		if (subList != null) {
			for (DynFormField field : subList)
	...
	public String getDataTypeUnprefixed() {
		...
		return (datatype != null) && datatype.contains(":") ? datatype.substring(datatype.indexOf(':') + 1) : datatype;
	}
	...
	public boolean isRequired() {
		_required = (!(isInputOnly() || hasZeroMinimum() || _attributes.isOptional())) || _attributes.isMandatory();
		return _required;
	}
	...
	public boolean isPrimitiveType() {
		...
		return (type.equals("string") || type.equals("double") || type.equals("long") || type.equals("boolean")
				|| type.equals("date") || type.equals("time") || type.equals("duration"));
	}

	public boolean equals(DynFormField other) {
		return (other.getName().equals(this.getName()) && other.getDatatype().equals(this.getDatatype()));
	}
	...
	public boolean isInputOnly() {
		return (hasParent() && _parent.isInputOnly())
				|| (_param != null && (_param.isInputOnly() || _param.isReadOnly())) || _attributes.isReadOnly()
				|| hasBlackoutAttribute();
	}

	public boolean hasHideAttribute() {
		return (hasParent() && _parent.hasHideAttribute()) || _hidden || _attributes.isHidden();
	}

	public boolean hasHideIfAttribute(String data) {
		return (hasParent() && _parent.hasHideIfAttribute(data)) || _attributes.isHideIf(data);
	}
	...
	public String getDefaultToolTip() {
		...
		String type = (_param.getDataTypeName().equals("YTimerType"))
	...
	public boolean hasSkipValidationAttribute() {
		return (hasParent() && _parent.hasSkipValidationAttribute()) || _attributes.isSkipValidation();
	}
	...
	public boolean hasBlackoutAttribute() {
		return (hasParent() && _parent.hasBlackoutAttribute()) || _attributes.isBlackout();
	}

	public String getUserDefinedFontStyle() {
		return hasParent() ? _parent.getUserDefinedFontStyle() : _attributes.getUserDefinedFontStyle();
	}

	public String getBackgroundColour() {
		return hasParent() ? _parent.getBackgroundColour() : _attributes.getBackgroundColour();
	}
	...
	public Font getUserDefinedFont() {
		return hasParent() ? _parent.getUserDefinedFont() : _attributes.getUserDefinedFont();
	}
