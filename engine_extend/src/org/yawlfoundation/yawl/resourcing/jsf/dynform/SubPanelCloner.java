...
public class SubPanelCloner {
	...
	public UIComponent cloneTextField(UIComponent field) {
		...
		_factory.addClonedFieldToTable(oldField, newField); // for later
															// validation
		return newField;
	}
	...
	private void resolveChildControllers(SubPanel panel) {
		Map<String, SubPanelController> processed = new Hashtable<String, SubPanelController>();
		...
		if (!processed.isEmpty())
			_factory.addSubPanelControllerMap(processed);
	}
