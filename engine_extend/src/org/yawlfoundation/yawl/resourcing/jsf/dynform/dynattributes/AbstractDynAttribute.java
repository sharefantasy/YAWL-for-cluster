...
public abstract class AbstractDynAttribute {
	 ...
	 * 
	 * @param fieldList
	 *            the list of DynFormField objects for the form. Note that a
	 *            DynFormField can have DynFormField children of its own,
	 *            hierarchically.
	 * @param wir
	 *            the workitem being displayed on the form
	 * @param p
	 *            the participant generating the form
	 */
