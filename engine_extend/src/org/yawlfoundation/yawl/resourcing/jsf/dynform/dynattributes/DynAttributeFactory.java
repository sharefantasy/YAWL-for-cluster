...
/**
 * This factory class creates and instantiates instances of the various dynamic
 * form attribute classes found in this package or on external classpaths.
 *
...
public class DynAttributeFactory {
	...
	} // block initialisation - static methods only
	...
	/**
	 * Constructs and returns a list of instantiated dynAttribute objects, one
	 * for each of the different dynAttribute classes available in this package
	 *
