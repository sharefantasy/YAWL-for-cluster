...
public class externalClients extends AbstractPageBean {
	...
	public void setClientList(List<YExternalClient> d) {
		clientList = d;
	}
	...
	public String getAddPanelHeading() {
		return addPanelHeading;
	}

	public void setAddPanelHeading(String heading) {
		addPanelHeading = heading;
	}
	...
	private boolean inputsValid() {
		if (isNullOrEmpty((String) txtName.getText()) || isNullOrEmpty((String) txtPassword.getText())
