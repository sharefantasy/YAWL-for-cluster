 ...
 *
 * @author Michael Adams Date: 26/01/2008 Last Date: 09/05/2008
 */
...
public class participantData extends AbstractPageBean {
	...
	public void setTxtNewPassword(PasswordField pw) {
		txtNewPassword = pw;
	}
	...
	public void setTxtConfirmPassword(PasswordField pw) {
	...
	public void setLblFirstName(Label l) {
		lblFirstName = l;
	}
	...
	public void setLblUserID(Label l) {
		lblUserID = l;
	}
	...
	public void setLblLastName(Label l) {
		lblLastName = l;
	}
	...
	public void setLblConfirm(Label l) {
		lblConfirm = l;
	}
	...
	private void populateFields(Participant p) {
		...
		((pfAddRemove) getBean("pfAddRemove")).populateLists(tabSetAttributes.getSelected(), p);
	}
	...
	private void saveChanges(Participant p) {
		...
		// only change password if a new one is entered and after its been
		// validated
