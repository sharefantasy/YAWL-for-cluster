 ...
 *
 *         Date: 31/01/2008 Last Date: 16/03/2008
 */
...
public class viewProfile extends AbstractPageBean {
	...
	public String btnUnpile_action() {
		...
		if (selected != null) {
			...
			if (selectedMap != null) {
				...
				msgPanel.error("Failed to unpile task - could not load piled mappings.");
		} else
			msgPanel.warn("No task selected to unpile");
		return null;
	}
	...
	private void showMessagePanel() {
		body1.setFocus(msgPanel.hasMessage() ? "form1:pfMsgPanel:btnOK001" : "form1:txtNewPassword");
