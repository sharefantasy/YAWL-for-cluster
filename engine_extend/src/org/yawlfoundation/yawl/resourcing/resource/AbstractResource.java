...
public abstract class AbstractResource implements Cloneable {
	...
	// the msecs this resource is 'offline' for after use, before it can be used
	// again
	...
	public boolean equals(Object o) {
		return (o == this) || ((o instanceof AbstractResource) && (((AbstractResource) o).getID() != null)
	...
	// returns true if this resource has no calendar entries between 'from' and
	// 'to' dates
