...
/**
 * Represents an organisational group to which a position (occupied by a
 * participant) may belong. Note that one org group may belong to a larger org
 * group (or alternately, an org group may contain a number of smaller org
 * groups).
 *
...
public class OrgGroup extends AbstractResourceAttribute implements Comparable {
	...
	public OrgGroup(String groupName, GroupType groupType, OrgGroup belongsTo, String description) {
		super();
	...
	public OrgGroup(String groupName, GroupType groupType, OrgGroup belongsTo, String description, boolean persisting) {
	...
	public boolean hasResourceInHierarchy(AbstractResource resource) {
		return hasResource(resource) || ((_belongsTo != null) && _belongsTo.hasResourceInHierarchy(resource));
	}
	...
	public int compareTo(Object o) {
		if ((o == null) || (!(o instanceof OrgGroup)))
			return 1;
