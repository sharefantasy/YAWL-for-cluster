...
/**
 * Represents a single participant (i.e. human) resource. Also manages the
...
public class Participant extends AbstractResource implements Cloneable {
	...
	public Participant(String lastname, String firstname, String userID, boolean isAdministrator,
	...
	private ResourceManager getResourceManager() throws ResourceGatewayException {
		try {
			...
			throw new ResourceGatewayException("Illegal access attempt to server-side method from resource gateway",
					ndf);
		}
	}
	...
	public void setUserID(String id) {
		_userID = id.replaceAll(" ", "_"); // replace any spaces with
											// underscrores
	}
