...
public class UserPrivileges implements Serializable {
	...
	public UserPrivileges(String pid, boolean canChooseItemToStart, boolean canStartConcurrent, boolean canReorder,
			boolean canViewAllOffered, boolean canViewAllAllocated, boolean canViewAllExecuting,
			boolean canViewTeamItems, boolean canViewOrgGroupItems, boolean canChainExecution, boolean canManageCases) {
	...
	public UserPrivileges clone() {
		return new UserPrivileges(_participantID, canChooseItemToStart, canStartConcurrent, canReorder,
				canViewAllOffered, canViewAllAllocated, canViewAllExecuting, canViewTeamItems, canViewOrgGroupItems,
	...
	public String toXML() {
		...
		xml.append(" participantid=\"").append(_participantID).append("\">")
				...
				// .append(wrapPrivilege(canViewAllOffered(),
				// "canViewAllOffered"))
				// .append(wrapPrivilege(canViewAllAllocated(),
				// "canViewAllAllocated"))
				// .append(wrapPrivilege(canViewAllExecuting(),
				// "canViewAllExecuting"))
