...
public class NonHumanResource extends AbstractResource implements Comparable, Cloneable {
	...
	public String getSubCategoryName() {
		NonHumanSubCategory subCategory = (_category != null) ? _category.getResourceSubCategory(this) : null;
		return (subCategory != null) ? subCategory.getName() : null;
	}

	public void setSubCategory(String subCategory) {
		String currentSubCategory = getSubCategoryName();
		if ((_category != null) && (subCategory != null) && (!subCategory.equals(currentSubCategory))) {
	...
	public boolean hasCategory(String category, String subCategory) {
		return (_category != null) && _category.getName().equals(category) && _category.hasResource(this, subCategory);
	}

	public int compareTo(Object o) {
		if ((o == null) || (!(o instanceof NonHumanResource)))
			return 1;
	...
	public NonHumanResource clone() throws CloneNotSupportedException {
		...
		cloned.setSubCategory(getSubCategoryName()); // adds cloned to subcat
														// resources
		return cloned;
	}
	...
	public String toXML() {
		...
		NonHumanSubCategory subCategory = getSubCategory();
		if (subCategory != null)
			node.addChild(subCategory.toXNode());
