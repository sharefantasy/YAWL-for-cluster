...
/**
 * The Calendar Gateway class acts as an API gateway between the resource
 * service and its calendar sub-service.
 *
 * @author Michael Adams 31/08/2010
 */
			...
			if (action.equals("getAvailability")) {
				...
				if (resourceXML != null) {
					...
					if (slots != null) {
						...
						result = _invalidResource;
				} else
					result = _nullResource;
