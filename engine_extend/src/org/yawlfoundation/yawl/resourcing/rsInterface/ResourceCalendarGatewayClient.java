...
public class ResourceCalendarGatewayClient extends Interface_Client {
	...
	/**
	 * the uri of the resource service's __ calendar gateway__ a default would
	 * be "http://localhost:8080/resourceService/calendarGateway"
	 */
	...
	/**
	 * Registers a URI as a listener for status change events. Note that only
	 * changes that affect the owner of the handle will receive events via the
	 * URI.
	 * 
	 * @param uri
	 *            the uri to which status change announcements are made
	 * @param handle
	 ...
	 * 
	 * @param uri
	 *            the uri to remove as a listener for status change
	 *            announcements
	 * @param handle
	 *            a valid session handle
	 * @throws IOException
	 ...
	 * 
	 * @param resourceXML
	 *            the resource record to check for availability
	 * @param from
	 ...
	 *             if the service can't be reached
	 */
	public String getAvailability(String resourceXML, long from, long to, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String getAvailability(String resourceXML, Date fromDate, Date toDate, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String getResourceAvailability(String resourceID, long from, long to, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String getResourceAvailability(String resourceID, Date fromDate, Date toDate, String handle)
			throws IOException {
		long from = (fromDate != null) ? fromDate.getTime() : -1;
		long to = (toDate != null) ? toDate.getTime() : -1;
	...
	/**
	 * Gets all the current reservations held for a resource within a time
	 * period
	 * 
	 * @param resourceXML
	 *            the resource(s) to get the reservations for
	 * @param from
	 *            the start of the date/time range
	 * @param to
	 *            the end of the date/time range
	 ...
	 *             if the service can't be reached
	 */
	public String getReservations(String resourceXML, long from, long to, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String getReservations(String resourceXML, Date fromDate, Date toDate, String handle) throws IOException {
		long from = (fromDate != null) ? fromDate.getTime() : -1;
		long to = (toDate != null) ? toDate.getTime() : -1;
	 ...
	 * 
	 * @param planXML
	 *            the UtilisationPlan containing the reservations
	 * @param checkOnly
	 *            if true, will report on the effects only - won't update the
	 *            reservations
	 * @param handle
	 *            a valid session handle
	 ...
	 *             if the service can't be reached
	 */
	public String saveReservations(String planXML, boolean checkOnly, String handle) throws IOException {
