 ...
 *
 * @author Michael Adams 14/08/2007
 */

public class ResourceGatewayClient extends Interface_Client {

	/**
	 * the uri of the resource service's __ resource gateway__ a default would
	 * be "http://localhost:8080/resourceService/gateway"
	 */
	 ...
	 * 
	 * @param uri
	 *            the uri of the resourceService's gateway
	 */
	 ...
	 * 
	 * @param action
	 *            the name of the gateway method to call
	 * @param handle
	 ...
	 * @param id
	 *            an identifier used as a parameter for the boolean action
	 *            passed
	 * @param handle
	 *            a valid session handle
	 ...
	 * @param format
	 *            how to format the output; valid values are "XML" or "JSON"
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the OrgGroup id/name pairs, or an
	...
	/**
	 * Gets an XML list of the full name of each Participant known to the
	 * service
	 * 
	 * @param handle
	 *            a valid session handle
	...
	/**
	 * Gets an XML list of the name of each NonHumanResource known to the
	 * service
	 * 
	 * @param handle
	 *            a valid session handle
	 ...
	 * 
	 * @param id
	 *            the id of the NonHumanResource to retrieve
	 * @param handle
	 *            a valid session handle
	 ...
	 * 
	 * @param name
	 *            the name of the role (not the id)
	 * @param handle
	 *            a valid session handle
	 ...
	 * 
	 * @param name
	 *            the name of the position (not the id)
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the participants
	 * @throws IOException
	 ...
	 * 
	 * @param name
	 *            the name of the capability (not the id)
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the participants
	 * @throws IOException
	 ...
	 * 
	 * @param userID
	 *            the userid to match to a participant
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the participant, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the role, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param id
	 *            the id of the Capability to get
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Capability, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Position, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param name
	 *            the name of the Position to get
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Position, or an appropriate error
	 *         message
	 ...
	 * 
	 * @param id
	 *            the id of the OrgGroup to get
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the OrgGroup, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param name
	 *            the name of the OrgGroup to get
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the OrgGroup, or an appropriate error
	 *         message
	 ...
	 * 
	 * @param name
	 *            the name of the NonHumanResource to get
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the NonHumanResource, or an appropriate
	 *         error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param id
	 *            a valid ResourceDataSet.Identifier; one of: FullName,
	 *            ReverseFullName, LastName or Userid (0..3)
	 * @param format
	 *            how to format the output; valid values are "XML" or "JSON"
	 * @param handle
	 *            a valid session handle
	 * @return a string describing the Participant id/name pairs, or an
	 *         appropriate error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	public String getParticipantIdentifiers(int id, String format, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String getParticipantIdentifiers(String format, String handle) throws IOException {
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Participant id/name pairs, or an
	 *         appropriate error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the NonHumanResource id/name pairs, or
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Role id/name pairs, or an
	 *         appropriate error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Position id/name pairs, or an
	 *         appropriate error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the Capability id/name pairs, or an
	 *         appropriate error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param id
	 *            the id of the Participant to get the user privileges of
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the UserPrivileges, or an appropriate
	 *         error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param id
	 *            a valid NonHumanCategory identifier
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the category, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 *             if the service can't be reached
	 */
	public String getNonHumanCategoryByName(String name, String handle) throws IOException {
		Map<String, String> params = prepareParamMap("getNonHumanCategoryByName", handle);
		params.put("name", name);
		return executeGet(_serviceURI, params);
	}
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the categories, or an appropriate error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * 
	 * @param id
	 *            the category id to get the sub-categories for
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the categories, or an appropriate error
	 *         message
	 ...
	 *             if the service can't be reached
	 */
	public String getNonHumanSubCategories(String id, String handle) throws IOException {
	 ...
	 *            the category id to get the sub-categories for
	 * @param format
	 *            how to format the output; valid values are "XML" or "JSON" - a
	 *            null value defaults to XML
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the categories, or an appropriate error
	 *         message
	 ...
	 *             if the service can't be reached
	 */
	public String getNonHumanSubCategories(String id, String format, String handle) throws IOException {
	 ...
	 * 
	 * @param category
	 *            the category to get the sub-categories for
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the categories, or an appropriate error
	 *         message
	 ...
	 *             if the service can't be reached
	 */
	public String getNonHumanSubCategoriesByName(String category, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String getNonHumanSubCategoriesByName(String category, String format, String handle) throws IOException {
	...
	/**
	 * Gets all the NonHumanResource categories known to the service, together
	 * with each of their subcategories
	 * 
	 * @param handle
	 *            a valid session handle
	 * @return an XML string describing the categories, or an appropriate error
	 ...
	 * @param checkForAdmin
	 *            when true, also checks that the user has admin privileges
	 * @param handle
	 *            a valid session handle
	 ...
	 * 
	 * @param codeletName
	 *            the simple name of the codelet
	 * @param handle
	 *            a valid session handle
	 * @return the list of the codelet's required parameters as an XML string,
	 *         or an error message if the codelet could not be found
	 * @throws IOException
	 *             if the service can't be reached
	 */
	public String getCodeletParameters(String codeletName, String handle) throws IOException {
	 ...
	 * 
	 * @param anyID
	 *            the id of a Participant, Role, Capability, Position or
	 *            OrgGroup
	 * @param handle
	 *            a valid session handle
	 * @return the list of the ids of all participants who are members of the
	 *         group object referenced; if anyID is the id of a single
	 *         participant, then only that id is returned in the list
	 * @throws IOException
	 *             if the service can't be reached
	 */
	public String getReferencedParticipantIDs(String anyID, String handle) throws IOException {
		Map<String, String> params = prepareParamMap("getReferencedParticipantIDsAsXML", handle);
		params.put("id", anyID);
		return executeGet(_serviceURI, params);
	}
	 ...
	 *             if the service can't be reached
	 */
	public String isKnownParticipant(String participantID, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String isKnownCapability(String capabilityID, String handle) throws IOException {
	 ...
	 * 
	 * @param handle
	 *            the sessionHandle to disconnect
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return if successful, the id of the newly added NonHumanResource; if
	 *         not, an explanatory error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	public String addNonHumanResource(String name, String category, String subcategory, String description,
	 ...
	 *             if the service can't be reached
	 */
	public String addCapability(String name, String description, String notes, String handle) throws IOException {
	 ...
	 * @param description
	 * @param notes
	 * @param containingRoleID
	 *            the id of the Role this Role will 'belong to' (may be null)
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 ...
	 *             if the service can't be reached
	 */
	public String addRole(String name, String description, String notes, String containingRoleID, String handle)
			throws IOException {
	 ...
	 * @param notes
	 * @param orgGroupID
	 *            the id of the OrgGroup this Position will 'belong to' (may be
	 *            null)
	 * @param containingPositionID
	 *            the id of the Position this Position will 'report to' (may be
	 *            null)
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 ...
	 *             if the service can't be reached
	 */
	public String addPosition(String name, String positionID, String description, String notes, String orgGroupID,
			String containingPositionID, String handle) throws IOException {
	 ...
	 *            - must not already exist in the service's org data
	 * @param groupType
	 *            one of the OrgGroup.GroupType's
	 * @param description
	 * @param notes
	 * @param containingGroupID
	 *            the id of the OrgGroup this OrgGroup will 'belong to' (may be
	 *            null)
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 ...
	 *             if the service can't be reached
	 */
	public String addOrgGroup(String name, String groupType, String description, String notes, String containingGroupID,
	 ...
	 * 
	 * @param participantID
	 *            the (existing) id of the Participant to add
	 * @param roleID
	 *            the (existing) id of the Role to add the Participant to
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 ...
	 *             if the service can't be reached
	 */
	public String addParticipantToRole(String participantID, String roleID, String handle) throws IOException {
	 ...
	 *            the (existing) id of the Participant to add
	 * @param capabilityID
	 *            the (existing) id of the Capability to add the Participant to
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String addParticipantToCapability(String participantID, String capabilityID, String handle)
			throws IOException {
	 ...
	 *            the (existing) id of the Participant to add
	 * @param positionID
	 *            the (existing) id of the Position to add the Participant to
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String addParticipantToPosition(String participantID, String positionID, String handle) throws IOException {
	 ...
	 * 
	 * @param category
	 *            the category name to add
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a String conversion of the (long) category key value, or if not
	 *         successful, an explanatory error message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	public String addNonHumanCategory(String category, String handle) throws IOException {
	 ...
	 * 
	 * @param category
	 *            the (existing) category name
	 * @param subcategory
	 *            the subcategory name to add
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String addNonHumanSubCategoryByName(String category, String subcategory, String handle) throws IOException {
	 ...
	 * 
	 * @param id
	 *            the id of the (existing) category
	 * @param subcategory
	 *            the subcategory name to add
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 ...
	 *             if the service can't be reached
	 */
	public String addNonHumanSubCategory(String id, String subcategory, String handle) throws IOException {
		Map<String, String> params = prepareParamMap("addNonHumanSubCategory", handle);
		params.put("id", id);
		params.put("subcategory", subcategory);
		return executeGet(_serviceURI, params);
	 ...
	 * participantid and handle, all other String parameters may be null, which
	 * will indicate that the current value for that field is not to be updated
	 * (ie. the existing value is maintained).
	 * 
	 * @param participantID
	 ...
	 * resourceID and handle, all other String parameters may be null, which
	 * will indicate that the current value for that field is not to be updated
	 * (ie. the existing value is maintained).
	 * 
	 * @param resourceID
	 *            - the (existing) id of the NonHumanResource
	 * @param name
	 * @param category
	 * @param subcategory
	 * @param description
	 ...
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not, an explanatory error
	 *         message
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * indicate that the current value for that field is not to be updated (ie.
	 * the existing value is maintained).
	 * 
	 * @param capabilityID
	 *            the (existing) id of the Capability
	 * @param description
	 * @param notes
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 ...
	 *             if the service can't be reached
	 */
	public String updateCapability(String capabilityID, String name, String description, String notes, String handle)
			throws IOException {
	...
	/**
	 * Updates a Role record with the specified values. Note that besides roleID
	 * and handle, all other parameters may be null, which will indicate that
	 * the current value for that field is not to be updated (ie. the existing
	 * value is maintained).
	 * 
	 * @param roleID
	 *            the (existing) id of the Capability
	 ...
	 * @param notes
	 * @param containingRoleID
	 *            the id of the Role this Role will 'belong to'
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String updateRole(String roleID, String name, String description, String notes, String containingRoleID,
			String handle) throws IOException {
	 ...
	 * posID and handle, all other parameters may be null, which will indicate
	 * that the current value for that field is not to be updated (ie. the
	 * existing value is maintained).
	 * 
	 * @param posID
	 *            the (existing) id of the Position
	 * @param name
	 * @param description
	 * @param notes
	 * @param orgGroupID
	 *            the id of the OrgGroup this Position will 'belong to'
	 * @param containingPositionID
	 *            the id of the Position this Position will 'report to'
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String updatePosition(String posID, String name, String positionID, String description, String notes,
			String orgGroupID, String containingPositionID, String handle) throws IOException {
	 ...
	 * groupID and handle, all other parameters may be null, which will indicate
	 * that the current value for that field is not to be updated (ie. the
	 * existing value is maintained).
	 * 
	 * @param groupID
	 *            the (existing) id of the OrgGroup
	 * @param name
	 * @param groupType
	 *            one of the OrgGroup.GroupType's
	 * @param description
	 * @param notes
	 * @param containingGroupID
	 *            the id of the OrgGroup this OrgGroup will 'belong to'
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String updateOrgGroup(String groupID, String name, String groupType, String description, String notes,
			String containingGroupID, String handle) throws IOException {
	 ...
	 * categoryid and handle, all other String parameters may be null, which
	 * will indicate that the current value for that field is not to be updated
	 * (ie. the existing value is maintained).
	 * 
	 * @param categoryID
	 *            the (existing) id of the NonHumanCategory
	 * @param name
	 * @param description
	 * @param notes
	 * @param handle
	 ...
	 *             if the service can't be reached
	 */
	public String removeParticipant(String participantID, String handle) throws IOException {
	...
	/**
	 * Removes (deletes) the specified NonHumanResource from the Service's org
	 * data
	 * 
	 * @param resourceID
	 *            the id of the Participant to remove
	 ...
	 *             if the service can't be reached
	 */
	public String removeNonHumanResource(String resourceID, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String removeCapability(String capabilityID, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String removeRole(String roleID, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String removePosition(String positionID, String handle) throws IOException {
	 ...
	 * 
	 * @param groupID
	 *            the id of the OrgGroup to remove
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String removeOrgGroup(String groupID, String handle) throws IOException {
	 ...
	 *            the id of the Participant to remove
	 * @param roleID
	 *            the id of the Role to remove the Particpant from
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String removeParticipantFromRole(String participantID, String roleID, String handle) throws IOException {
	 ...
	 *            the id of the Participant to remove
	 * @param capabilityID
	 *            the id of the Capability to remove the Particpant from
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String removeParticipantFromCapability(String participantID, String capabilityID, String handle)
			throws IOException {
	 ...
	 *            the id of the Participant to remove
	 * @param positionID
	 *            the id of the Position to remove the Particpant from
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String removeParticipantFromPosition(String participantID, String positionID, String handle)
			throws IOException {
	...
	/**
	 * Removes the specified category from the set of NonHumanResource
	 * categories; any sub-categories of the specified categories are also
	 * removed.
	 * 
	 * @param id
	 ...
	 *             if the service can't be reached
	 */
	public String removeNonHumanCategory(String id, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String removeNonHumanCategoryByName(String category, String handle) throws IOException {
		Map<String, String> params = prepareParamMap("removeNonHumanCategoryByName", handle);
		params.put("category", category);
		return executeGet(_serviceURI, params);
	}
	 ...
	 * 
	 * @param category
	 *            the name of the category of which the subcategory is a member
	 * @param subcategory
	 *            the name of the subcategory to remove
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String removeNonHumanSubCategoryByName(String category, String subcategory, String handle)
			throws IOException {
		Map<String, String> params = prepareParamMap("removeNonHumanSubCategoryByName", handle);
		params.put("category", category);
		params.put("subcategory", subcategory);
		return executeGet(_serviceURI, params);
	}
	 ...
	 * 
	 * @param id
	 *            the identifier of the category of which the subcategory is a
	 *            member
	 * @param subcategory
	 *            the name of the subcategory to remove
	 * @param handle
	 ...
	 *             if the service can't be reached
	 */
	public String removeNonHumanSubCategory(String id, String subcategory, String handle) throws IOException {
	...
	/**
	 * Sets the containing Role for a Role (i.e. the 'parent' Role the Role
	 * 'belongs to')
	 * 
	 * @param roleID
	 *            the id of the 'child' Role
	 * @param containingRoleID
	 *            the id of the containing or parent Role that encapsulates the
	 *            'child' Role
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 ...
	 *             if the service can't be reached
	 */
	public String setContainingRole(String roleID, String containingRoleID, String handle) throws IOException {
	...
	/**
	 * Sets the containing OrgGroup for an OrgGroup (i.e. the 'parent' OrgGroup
	 * the OrgGroup 'belongs to')
	 * 
	 * @param groupID
	 *            the id of the 'child' OrgGroup
	 * @param containingGroupID
	 *            the id of the containing or parent OrgGroup that encapsulates
	 *            the 'child' OrgGroup
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 ...
	 *             if the service can't be reached
	 */
	public String setContainingOrgGroup(String groupID, String containingGroupID, String handle) throws IOException {
	...
	/**
	 * Sets the containing Position for a Position (i.e. the 'parent' Position
	 * the Position 'reports to')
	 * 
	 * @param positionID
	 *            the id of the 'child' Position
	 * @param containingPositionID
	 *            the id of the containing or parent Position that encapsulates
	 *            the 'child' Position
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 ...
	 *             if the service can't be reached
	 */
	public String setContainingPosition(String positionID, String containingPositionID, String handle)
			throws IOException {
	 ...
	 * @param groupID
	 *            the id of the containing OrgGroup
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String setPositionOrgGroup(String positionID, String groupID, String handle) throws IOException {
	 ...
	 *             if the service can't be reached
	 */
	public String setParticipantPrivileges(String participantID, boolean canChooseItemToStart,
			boolean canStartConcurrent, boolean canReorder, boolean canViewTeamItems, boolean canViewOrgGroupItems,
			boolean canChainExecution, boolean canManageCases, String handle) throws IOException {
	...
	/**
	 * Sets the user privileges of the specified participant individually via a
	 * 'bit string'
	 * 
	 * @param participantID
	 *            the (existing) id of the participant
	 * @param bits
	 *            an eight character string where each character corresponds to
	 *            a privilege (see the alternate setParticipantPrivileges()
	 *            method for the ordering). For each privilege, a character
	 *            value of '1' indicates that the privilege is to be granted and
	 *            a character of any other value indicates that the privilege is
	 *            to be denied. The last character overrides all other
	 *            privileges, so that a value of '1' in the last position grants
	 *            all privileges, while any other value in the last position
	 *            defers to the individual settings of each privilege.
	 * @param handle
	 *            a current sessionhandle with admin privileges
	 * @return a message indicating success, or if not successful, an
	 *         explanatory error message
	 ...
	 *             if the service can't be reached
	 */
	public String setParticipantPrivileges(String participantID, String bits, String handle) throws IOException {
		if (bits.length() != 8) {
	...
	/**
	 * Sets the user privileges of the specified participant on an 'all on' or
	 * 'all off' basis
	 * 
	 * @param participantID
	 *            the (existing) id of the participant
	 * @param carteblanche
	 *            if true, grants the participant all user privileges; if false,
	 ...
	 *             if the service can't be reached
	 */
	public String setParticipantPrivileges(String participantID, boolean carteblanche, String handle)
			throws IOException {
