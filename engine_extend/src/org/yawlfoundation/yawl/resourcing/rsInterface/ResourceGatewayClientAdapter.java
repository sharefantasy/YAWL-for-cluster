...
/**
 * This adapter class adds a transformation layer to the resource gateway
 * client, effectively reconstituting the Strings returned from the gateway into
 * java objects.
 *
 * Author: Michael Adams Date: 26/10/2007
 *
 */
...
public class ResourceGatewayClientAdapter {
	 ...
	 * 
	 * @param csv
	 *            the string of items separated by commas
	...
	private List<String> CSVToStringList(String csv) {
		...
		// split the string on the commas and add each resultant string to the
		// List
	...
	/**
	 * Converts an XML string into a Map of string key/value pairs. Assumes the
	 * xml contains a set of child items, each with an 'id' attribute and a text
	 * value.
	 * 
	 * @param xml
	 *            the xml string to parse
	 * @return a Map of String key/value pairs, or null if the string can't be
	 *         parsed.
	 */
	...
	/**
	 * Converts the string passed to a JDOM Element and returns its child
	 * Elements
	 * 
	 * @param s
	 ...
	 * 
	 * @pre className is the valid name of a class that extends from the base
	 *      AbstractResourceAtttribute
	 * @param className
	 *            the name of the extended class to create
	 * @return An instantiated class of type 'className', or null if there's a
	 *         problem
	 */
	 ...
	 * ResourceAttribute child objects (i.e. Role, Position, Capability,
	 * OrgGroup)
	 * 
	 * @param xml
	 *            the string to be converted to a JDOM Element
	 * @param className
	 *            the type of child class to instantiate
	 ...
	 * 
	 * @param handle
	 *            the sessionhandle of the session to disconnect
	 */
	 ...
	 *             if there was a problem validating the credentials
	 */
	 ...
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the names
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the NonHumanResource
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the roles
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the capabilities
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the positions
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the groups
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the participants
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the participant
	 */
	 ...
	 * @param handle
	 *            a valid session handle
	 * @return the set of the ids of all participants who are members of the
	 *         group object referenced; if anyID is the id of a single
	 *         participant, then only that id is returned in the set
	 * @throws IOException
	 *             if the service can't be reached
	 */
	 ...
	 * @param handle
	 *            the current sessionhandle
	 * @return a List of Constraint objects (instantiated as GenericConstraint
	 *         objs)
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the constraints
	 */
	 ...
	 * @param handle
	 *            the current sessionhandle
	 * @return a List of Allocator objects (instantiated as GenericAllocator
	 *         objs)
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the allocators
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the filters
	 */
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the codelets
	 */
	 ...
	 * 
	 * @param pid
	 *            the id of the Participant of interest
	 * @param handle
	 *            the current sessionhandle
	 * @return a List of (Role) objects
	 * @throws IOException
	 ...
	 * 
	 * @param roleName
	 *            the name of the role in question (not the id)
	 * @param handle
	 *            the current sessionhandle
	 ...
	 * 
	 * @param positionName
	 *            the name of the position in question (not the id)
	 * @param handle
	 *            the current sessionhandle
	 * @return a Set of Participant objects
	 * @throws IOException
	 ...
	 *            the name of the capability in question (not the id)
	 * @param handle
	 *            the current sessionhandle
	 * @return a Set of Participant objects
	 * @throws IOException
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Participant
	 */
	 ...
	 * 
	 * @param id
	 *            the id of the NonHumanResource to get
	 * @param handle
	 *            a valid session handle
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the NonHumanResource
	 */
	public NonHumanResource getNonHumanResource(String id, String handle) throws IOException, ResourceGatewayException {
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Role
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Capability
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Position
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the OrgGroup
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Participants
	 */
	public Map<String, String> getParticipantIdentifiers(String handle) throws IOException, ResourceGatewayException {
	 ...
	 * 
	 * @param identifier
	 *            a valid ResourceDataSet Identifier value
	 * @param handle
	 *            a valid session handle
	 * @return a Map of Participant id/name pairs
	 * @throws IOException
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the NonHumanResources
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Roles
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Positions
	 */
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the Capabilities
	 */
	public Map<String, String> getCapabilityIdentifiers(String handle) throws IOException, ResourceGatewayException {
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the OrgGroups
	 */
	 ...
	 * 
	 * @param id
	 *            the id of the Participant to get the UserPrivileges for
	 * @param handle
	 *            a valid session handle
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there is some problem getting the UserPrivileges
	 */
	 ...
	 * @param handle
	 *            the current sessionhandle
	 * @return the id of the newly added Participant, or an error message if
	 *         there was a problem (note: the returned id should be subsequently
	 *         added to the Participant object using p.setID() )
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	 ...
	 *            if true, will encrypt the current password within 'p' before
	 *            storing it on the server side (recommended for plain text
	 *            passwords)
	 * @param handle
	 *            the current sessionhandle
	 * @return the id of the newly added Participant, or an error message if
	 ...
	 * 
	 * @param resource
	 *            the NonHumanResource
	 * @param handle
	 *            the current sessionhandle
	 * @return the id of the newly added NonHumanResource, or an error message
	 *         if there was a problem (note: the returned id should be
	 *         subsequently added to the NonHumanResource object using
	 *         resource.setID() )
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	 ...
	 * @param handle
	 *            the current sessionhandle
	 * @return the id of the newly added Capability, or an error message if
	 *         there was a problem (note: the returned id should be subsequently
	 *         added to the Capability object using cap.setID() )
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	 ...
	 *         a problem (note: the returned id should be subsequently added to
	 *         the Role object using role.setID() )
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	 ...
	 * @param handle
	 *            the current sessionhandle
	 * @return the id of the newly added Position, or an error message if there
	 *         was a problem (note: the returned id should be subsequently added
	 *         to the Position object using pos.setID() )
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	 ...
	 * @param handle
	 *            the current sessionhandle
	 * @return the id of the newly added OrgGroup, or an error message if there
	 *         was a problem (note: the returned id should be subsequently added
	 *         to the OrgGroup object using group.setID() )
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	 ...
	 *            the Participant
	 * @param role
	 *            the Role to add the Particpant to
	 * @param handle
	 *            the current sessionhandle
	 ...
	 *            the Participant
	 * @param cap
	 *            the Capability to add the Particpant to
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 *            the Participant
	 * @param pos
	 *            the Position to add the Particpant to
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	...
	/**
	 * Updates the Participant stored in the service's org data with the
	 * modified values of the Participant specified
	 * 
	 * @param p
	 *            the Participant
	 * @param encryptPassword
	...
	public String updateParticipant(Participant p, boolean encryptPassword, String handle) throws IOException {
		return _rgclient.updateParticipant(p.getID(), p.getUserID(), p.getPassword(), encryptPassword, p.getLastName(),
				p.getFirstName(), p.isAdministrator(), p.getDescription(), p.getNotes(), handle);
	}
	...
	/**
	 * Updates a new NonHumanResource to the service's org data with the
	 * modified values of the NonHumanResource specified
	 * 
	 * @param resource
	 *            the NonHumanResource
	 * @param handle
	...
	public String updateNonHumanResource(NonHumanResource resource, String handle) throws IOException {
		return _rgclient.updateNonHumanResource(resource.getID(), resource.getName(), resource.getCategory().getName(),
				resource.getSubCategoryName(), resource.getDescription(), resource.getNotes(), handle);
	}

	/**
	 * Updates the Capability stored in the service's org data with the modified
	 * values of the Capability specified
	 * 
	 * @param cap
	 *            the Capability
	 * @param handle
	...
	/**
	 * Updates the Role stored in the service's org data with the modified
	 * values of the Role specified
	 * 
	 * @param role
	 *            the Role
	 * @param handle
	...
	/**
	 * Updates the Position stored in the service's org data with the modified
	 * values of the Position specified
	 * 
	 * @param pos
	 *            the Position
	 * @param handle
	...
	/**
	 * Updates the OrgGroup stored in the service's org data with the modified
	 * values of the OrgGroup specified
	 * 
	 * @param group
	 *            the OrgGroup
	 * @param handle
	...
	/**
	 * Updates the NonHumanCategory stored in the service's org data with the
	 * modified values of the NonHumanResource specified
	 * 
	 * @param category
	 *            the NonHumanResource
	 ...
	 *            the Participant
	 * @param role
	 *            the Role to remove the specified Participant from
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 *            the Participant
	 * @param cap
	 *            the Capability to remove the specified Participant from
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 *            the Participant
	 * @param pos
	 *            the Position to remove the specified Participant from
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 * @param role
	 *            the Role
	 * @param containingRole
	 *            the containing or parent Role that encapsulates role
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 *            the containing or parent OrgGroup that encapsulates group
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 *             if there was a problem connecting to the resource service
	 */
	public String setContainingOrgGroup(OrgGroup group, OrgGroup containingGroup, String handle) throws IOException {
	 ...
	 *            the Position
	 * @param containingPos
	 *            the containing or parent Position that encapsulates pos
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 * 
	 * @param p
	 *            the Participant (note: the privilege values used are the ones
	 *            currently within the Participant object specified)
	 * @param handle
	 *            the current sessionhandle
	 * @return a message indicating success, or describing a problem encountered
	 * @throws IOException
	 ...
	 *             if the service can't be reached
	 * @throws ResourceGatewayException
	 *             if there was a problem getting the NonHumanCategory
	 */
	public NonHumanCategory getNonHumanCategory(String id, String handle) throws IOException, ResourceGatewayException {
	...
	/**
	 * Gets the list of all NonHumanCategory objects known to the Resource
	 * Service
	 * 
	 * @param handle
	 *            the current sessionhandle
	 ...
	 */
	public List<NonHumanCategory> getNonHumanCategories(String handle) throws IOException, ResourceGatewayException {
	 ...
	 * 
	 * @param id
	 *            the category id to get the subcategories for
	 * @param handle
	 *            the current sessionhandle
	 ...
	 * 
	 * @param category
	 *            the category name to get the subcategories for
	 * @param handle
	 *            the current sessionhandle
	 * @return a list of category name strings
	 * @throws IOException
	...
	/**
	 * Gets the list of all NonHumanResource category names and the
	 ...
	 *             if there was a problem getting the list
	 */
	public Map<String, Set<String>> getNonHumanCategorySet(String handle) throws IOException, ResourceGatewayException {
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem adding the category
	 */
	 ...
	 * 
	 * @param category
	 *            the category name to add the subcategory to
	 * @param subcategory
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem adding the subcategory
	 */
	 ...
	 * 
	 * @param id
	 *            the identifier of the category to add the subcategory to
	 * @param subcategory
	 *            the subcategory to add
	 * @param handle
	 *            the current sessionhandle
	 ...
	 * 
	 * @param id
	 *            the identifier of the category to remove; all of the
	 *            category's subcategories will also be removed
	 * @param handle
	 *            the current sessionhandle
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem removing the category
	 */
	 ...
	 * 
	 * @param category
	 *            the name of the category to remove the subcategory from
	 * @param subcategory
	 ...
	 *             if there was a problem connecting to the resource service
	 * @throws ResourceGatewayException
	 *             if there was a problem removing the subcategory
	 */
	 ...
	 * 
	 * @param id
	 *            the identifier of the category to remove the subcategory from
	 * @param subcategory
	 *            the subcategory name to remove
	 * @param handle
	 *            the current sessionhandle
