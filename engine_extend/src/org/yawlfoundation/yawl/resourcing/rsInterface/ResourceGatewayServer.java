...
public class ResourceGatewayServer extends Interface_Client {
	...
	private String _ixURI; // the uri to Interface X Service (exception
							// handling)
	private String _isURI; // the uri to Interface S Service (resource
							// scheduling)
	...
	public void announceResourceUnavailable(String resourceID, WorkItemRecord wir, String caseData, boolean primary)
			throws IOException {
	...
	public void announceResourceCalendarStatusChange(String origOwner, String xml) throws IOException {
	...
	public void redirectWorkItemToYawlService(String wirXML, String serviceURI) throws IOException {
