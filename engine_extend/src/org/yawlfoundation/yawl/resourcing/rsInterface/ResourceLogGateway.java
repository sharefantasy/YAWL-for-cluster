	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		if (action == null) {
			...
			if (action.equals("getCaseEvent")) {
				...
				result = (specID != null) ? _logDB.getSpecificationEvents(specID, from, to) : _badSpecID;
				...
				result = (idSet != null) ? _logDB.getSpecificationEvents(idSet, from, to) : _badSpecID;
				...
				YSpecificationID specID = constructSpecID(req);
				result = (specID != null) ? _logDB.getSpecificationStatistics(specID, from, to) : _badSpecID;
				...
				YSpecificationID specID = constructSpecID(req);
				result = (specID != null) ? _logDB.getTaskStatisticsForSpecification(specID, from, to) : _badSpecID;
			} else if (action.equals("getTaskStatisticsForSpecificationSet")) {
				String setXML = req.getParameter("setxml");
				Set<YSpecificationID> idSet = constructSpecificationIDSet(setXML);
				result = (idSet != null) ? _logDB.getTaskStatisticsForSpecificationSet(idSet, from, to) : _badSpecID;
				...
				result = (specID != null) ? _logDB.getTaskStatistics(specID, taskName, from, to) : _badSpecID;
	...
	private Set<YSpecificationID> constructSpecificationIDSet(String xml) {
		...
		if (specs != null) {
			for (XNode spec : specs.getChildren()) {
				specSet.add(new YSpecificationID(spec.getChildText("identifier"), spec.getChildText("version"),
						spec.getChildText("uri")));
			}
		}
		return specSet;
	}
