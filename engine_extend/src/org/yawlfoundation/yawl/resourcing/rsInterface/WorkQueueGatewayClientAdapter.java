 ...
 * java objects.
 * <p/>
 * Author: Michael Adams Date: 26/10/2007 Version: 2.0
 */
...
public class WorkQueueGatewayClientAdapter {
	...
	public String getFullNameForUserID(String userid, String handle) throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.getFullNameForUserID(userid, handle));
	}

	public UserPrivileges getUserPrivileges(String pid, String handle) throws IOException, ResourceGatewayException {
	...
	public TaskPrivileges getTaskPrivileges(String itemid, String handle) throws IOException, ResourceGatewayException {
		...
		for (XNode privilege : root.getChild("privileges").getChildren()) {
			...
			if (allowallStr != null) {
				if (allowallStr.equals("true")) {
					...
					taskPrivileges.disallowAll(name);
			}
	...
	public Set<Participant> getOrgGroupMembers(String oid, String handle) throws IOException, ResourceGatewayException {
		String xml = _wqclient.getOrgGroupMembers(oid, handle);
		return _marshaller.unmarshallParticipants(successCheck(xml));
	}

	public Set<Participant> getRoleMembers(String rid, String handle) throws IOException, ResourceGatewayException {
	...
	public Set<Participant> getAllParticipants(String handle) throws IOException, ResourceGatewayException {
	...
	public QueueSet getAdminQueues(String handle) throws IOException, ResourceGatewayException {
	...
	public String getWorkItemDataSchema(String itemID, String handle) throws IOException, ResourceGatewayException {
	...
	public Set<Participant> getParticipantsAssignedWorkItem(String workItemID, int queueType, String handle)
			throws IOException, ResourceGatewayException {
		String xml = _wqclient.getParticipantsAssignedWorkItem(workItemID, queueType, handle);
		return _marshaller.unmarshallParticipants(successCheck(xml));
	}

	public String acceptOffer(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
	...
	public String reallocateItem(String pFrom, String pTo, String itemID, boolean stateful, String handle)
			throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.reallocateItem(pFrom, pTo, itemID, stateful, handle));
	}

	public String skipItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.skipItem(pid, itemID, handle));
	}

	public String pileItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.pileItem(pid, itemID, handle));
	}

	public String suspendItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.suspendItem(pid, itemID, handle));
	}

	public String unsuspendItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.unsuspendItem(pid, itemID, handle));
	}

	public String completeItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
	...
	public String allocateItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
	...
	public String restartItem(String pid, String itemID, String handle) throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.restartItem(pid, itemID, handle));
	}

	public String redirectWorkItemToYawlService(String itemID, String serviceName, String handle)
			throws IOException, ResourceGatewayException {
		return successCheck(_wqclient.redirectWorkItemToYawlService(itemID, serviceName, handle));
	}
	...
	public SpecificationData getSpecData(YSpecificationID specID, String handle) throws IOException {
		String xml = _wqclient.getSpecData(specID, handle);
		return _marshaller.unmarshallSpecificationData(xml);
	}

	public String uploadSpecification(String fileContents, String fileName, String handle) throws IOException {
	...
	public String addRegisteredService(YAWLServiceReference service, String handle) throws IOException {
		return _wqclient.addRegisteredService(service.getURI(), service.get_serviceName(), service.getPassword(),
