...
/**
 * Author: Michael Adams Creation Date: 7/02/2008
 */
public class RandomOrgDataGenerator {
	...
	private String[] f = {"Alex", "Bill", "Carol", "Diane", "Errol", "Frank", "George", "Hillary", "Irene", "Jack",
			"Kate", "Larry", "Michael", "Neil", "Oprah", "Penny", "Quebert", "Ronald", "Sven", "Thomas", "Uri",
			"Victoria", "Wendy", "Xavier", "Yvonne", "Zac"};

	private String[] l = {"Adams", "Brown", "Cooper", "Donald", "Evans", "Ford", "Green", "Humphries", "Isaacs",
			"Jones", "Klein", "Locke", "McKay", "Nelson", "O'Brien", "Petersen", "Quincy", "Roberts", "Smith",
			"Thomson", "Ulrich", "Van Dyke", "Wilson", "Xerxes", "Young", "Zappa"};
	...
	public void generate(int count) {
		...
		if (okToGenerate()) {
			try {
				...
				for (int i = 0; i < 4; i++)
					positions[i].setOrgGroup(orgGroups[i]);
	...
	private OrgGroup[] createOrgGroups(ResourceDataSet orgDataSet) {
		OrgGroup o1 = new OrgGroup("SoftwareDiv", OrgGroup.GroupType.DIVISION, null, "Software Division", true);
		orgDataSet.addOrgGroup(o1);

		OrgGroup o2 = new OrgGroup("progDept", OrgGroup.GroupType.DEPARTMENT, o1, "Programming Department", true);
		orgDataSet.addOrgGroup(o2);

		OrgGroup o3 = new OrgGroup("teamA", OrgGroup.GroupType.TEAM, o2, "Code Team A", true);
		orgDataSet.addOrgGroup(o3);

		OrgGroup o4 = new OrgGroup("teamB", OrgGroup.GroupType.TEAM, o2, "Code Team B", true);
	...
	private void createParticipants(int howManyToCreate, Role[] roles, Position[] positions,
