...
/**
 * This object acts as a reusable Schema validator for a given schema. Once the
 * schema has been successfully compiled, any number of XML documents can be
 * validated by calling either of the validate methods.
 *
 * @author Mike Fowler Date: 04-Jul-2006
 */
public class SchemaHandler {

	// Raw schema source - can be initiated as a String, InputStream or a URL to
	// the xsd
	...
	// Captures all errors and warning relating to the parsing of an XML
	// document
	 ...
	 * 
	 * @param xml
	 *            XML String representing the schema this handler will use for
	 *            validation
	 */
	 ...
	 * 
	 * @param is
	 *            a Stream representing the schema this handler will use for
	 *            validation
	 */
	 ...
	 * 
	 * @param url
	 *            a URL to the XSD representing the schema this handler will use
	 *            for validation
	 */
	 ...
	 * 
	 * @param xml
	 *            the XML String to validate against Schema
	 * @return true if the Schema compiles without error AND the XML is a valid
	...
	/**
	 * Attempts to compile the schema. If successful, allows an XML document to
	 * be validated.
	 * 
	 ...
	 * 
	 * @param xml
	 *            instance document to be validated.
	 * @return true if the xml is a valid instance of the schema
	 * @throws IllegalStateException
	 *             if schema has not been compiled successfully
	 */
	public boolean validate(String xml) {
		if (!compiled) {
			throw new IllegalStateException(
					"Schema must first have been successfully " + "compiled before validation can be performed.");
		}
	...
	/**
	 * @param schema
	 *            new schema to use (resets everything)
	 */
