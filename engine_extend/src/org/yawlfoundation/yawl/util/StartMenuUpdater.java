...
public class StartMenuUpdater {
	...
	public void checkBatFile(File rootPath) {
		...
		if (!YawlBat.exists()) {
			...
			String content = "@echo off\r\n" + "if \"\"%1\"\" == \"\"controlpanel\"\" goto cp\r\n"
					...
					+ "goto usage\r\n\r\n" + ":cp\r\n" + "cd controlpanel\r\n" + java
					+ " -jar YawlControlPanel-3.0.1.jar\r\n" + "goto end\r\n\r\n" + ":editor\r\n" + "cd editor\r\n"
	...
	public class ScriptSettings {
		...
		public ScriptSettings setFolderName(String s) {
			folderName = s;
			return this;
		}

		public ScriptSettings setMenuName(String s) {
			menuName = s;
			return this;
		}

		public ScriptSettings setTargetPath(String s) {
			targetPath = s;
			return this;
		}

		public ScriptSettings setArguments(String s) {
			arguments = s;
			return this;
		}

		public ScriptSettings setDescription(String s) {
			description = s;
			return this;
		}

		public ScriptSettings setIconLocation(String s) {
			iconLocation = s;
			return this;
		}

		public ScriptSettings setWorkingDir(String s) {
			workingDir = s;
			return this;
		}
