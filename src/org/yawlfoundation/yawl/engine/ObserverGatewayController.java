...
/**
 * Class which encapsulates the management and processing of InterfaceB cluster.event observers.
 *
...
public class ObserverGatewayController {
    ...
    /**
     * Add an observerGateway, which will receive cluster.event callbacks from the engine.
