...
/**
 * A problem cluster.event describes the nature of a runtime execution problem.
 *
 * 
...
public class YProblemEvent {
    ...
    /**
     * Gets the message of the cluster.event, if any.
     * @return message
     */
    ...
    /**
     * Gets the source of the cluster.event.
     * @return cluster.event source object.
     */
    ...
    /**
     * Gets the cluster.event type.
     * @return cluster.event ype.
     */
