...
public class YWorkItem {
    ...
    /** completes persisting and cluster.event logging for a workitem */
    private void completePersistence(YPersistenceManager pmgr,
        ...
        // set final status, log cluster.event and remove from persistence
    ...
    /** completes persisting and cluster.event logging for a parent workitem if required */
    ...
    /** write data input values to cluster.event log */
    ...
    /** write output data values to cluster.event log */
