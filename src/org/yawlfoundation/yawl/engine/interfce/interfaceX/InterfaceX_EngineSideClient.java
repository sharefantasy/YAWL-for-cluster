...
/**
 *  InterfaceX_EngineSideClient passes exception cluster.event calls from the engine to the
 *  exception service.
 *
...
public class InterfaceX_EngineSideClient extends Interface_Client implements ExceptionGateway {
  ...
  ////////////////////////////////////////////////////////////////////////////////////
    ...
    private class Handler implements Runnable {
        ...
        /**
         * Different constructors for different cluster.event types
         */
        ...
        // POST the cluster.event
        public void run() {

           Map<String, String> paramsMap = new HashMap<String, String>();
           try {

               // all events have an cluster.event type
