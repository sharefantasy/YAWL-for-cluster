...
/**
 * One row of the logDataItem table, representing a data item associated with an cluster.event.
 * Note that an cluster.event may have a number of data items associated with it.
 *
