...
/**
 * One row of the logEvent table, representing a single net or task instance runtime cluster.event
 *
...
public class YLogEvent {
    ...
    private String descriptor ;             // the type of cluster.event
    ...
    public String toXML() {
        ...
        xml.append(String.format("<cluster.event key=\"%s\">", eventID));
