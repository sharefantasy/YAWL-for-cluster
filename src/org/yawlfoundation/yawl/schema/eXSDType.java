...
public enum eXSDType {
    ...
    private static final Map<String, eXSDType> _fromStringMap =
            new HashMap<String, eXSDType>();
    ...
    public String getString() { return _name; }
...
//        return type != null && (type.ordinal() >= INTEGER.ordinal()) && (ordinal <= DECIMAL);
//    }
//
